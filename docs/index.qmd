...
Docker is an open-source containerisation platform used for developing, deploying, and managing applications in lightweight virtualised environments called containers. This is used so that publications can be deployed in many different environments.
::: {.learn-more}
