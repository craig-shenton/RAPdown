...
Reproducible Analytical Pipelines are the gold standard for creating analytical outputs in government[^goldacre]:

- Transparancy increases trust and confidence in your results
- They allow others to easily verify and replicate your analyses
- Reduce the risk of human error and inconsistencies in your work
- Leaves your analysts time to focus on more complex analysis

::: {.hero-buttons}
[Get {RAP}down](docs/get-started/){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"}
[Read the docs](docs/guide/){#btn-guide .btn-action .btn .btn-info .btn-lg role="button"}
::: 
