...
![](_assets/img/hero_left.png){fig-alt="Stack of three printed articles with text, code, and graphics."}
:::
...
![](/_assets/img/hero_right.png){fig-alt="Stack of three printed articles with text, code, and graphics."}
:::
