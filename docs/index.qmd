...
Build fully reproducable data pipelines using `{targets}` to define dependencies in data processing and automatically render and rebuild quarto reports.
...
A shared library of tested functions allows complex analysis to be run with every step in a metric calculation fully validated and documented.
...
::: {.feature}
### Quality Assurance
Built-in unit tests, data validation, and schema checks ensure that data pipelines are functioning correctly, and the data follows the correct structure and format.
...
<a href="https://craig-shenton.github.io/RAPdown/examples/ae_attendances.html"><img src="_assets/img/example_screen.png" width="500" /></a>
