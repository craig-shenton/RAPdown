...
::: {.feature}
### CI GitHub Actions
Continuous integration with `Travis CI` automates builds and tests. So when something stops working you will both be informed about the problem and told how you can fix it. This can reduce the time it takes to validate new data and update your publications.
