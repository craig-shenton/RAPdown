...
section-divs: false
toc: false
css: _assets/style/index.css
editor: source
description: | 
  Quarto is an open-source scientific and technical publishing system built on Pandoc.
image: _assests/img/hero_right.png
---

::: {.hero-banner}

::: {.hero-image .hero-image-left}
![](_assests/img/hero_left.png){fig-alt="Stack of three printed articles with text, code, and graphics."}
:::
