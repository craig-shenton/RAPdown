...
<h1><img src="_assets/img/rapdown_colour.svg" width="100" height="100" /> {RAP}down Package</h1>

### A framework for creating Reproducible Analytical Pipeline (RAP) compliant Quarto publications

- RAP is the gold standard for creating analytical outputs in government
- RAP publications improve reliability, transparency, and reproducibility
...
### Read more about Reproducible Analytical Pipelines (RAP) at NHS Digital's Community of Practice
