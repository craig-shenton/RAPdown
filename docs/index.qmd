...
##### Reproducible Analytical Pipelines are the gold standard for creating analytical outputs in government and the public sector[^goldacre]

- RAP allows others to easily verify and replicate your analyses
- Transparancy increases trust and confidence in our publications
- Open standards promote best practice across industry
- Automation leaves time to focus on more advanced analytics
